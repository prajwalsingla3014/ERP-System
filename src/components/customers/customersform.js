                        ...
                        <div className="col-md-12">
                            <div className="card card-success" style={{border:'none',boxShadow:'0 0 1px rgba(0,0,0,0.1), 0 1px 2px rgba(0,0,0,0.1)'}}>
                                <div className="card-header">
                                    <h3 className="card-title" style={{fontSize:'20px',fontFamily:'Acme'}}>New Customer</h3>
                                </div>
                                <form className="form-horizontal" onSubmit={this.submitHandler}>
                                    <div className="card-body">
                                        <div className="form-group row">
                                            <label className="col-2 col-form-label" style={{fontSize:'20px',fontFamily:'Acme'}}>Customer Type</label>
                                        ...
                                        <div className="form-group row">
                                            <label  className="col-sm-2 col-form-label" style={{fontSize:'20px',fontFamily:'Acme'}}>Customer Display Name *</label>
                                            <div className="col-sm-10">
                                        ...
                                        <div className="form-group row">
                                            <label className="col-sm-2 col-form-label" style={{fontSize:'20px',fontFamily:'Acme'}}>Customer Email</label>
                                            <div className="col-sm-10">
                                                <input type="email" name="email" className="form-control" onChange={this.changeHandler} />
                                            </div>
                                        </div>
                                        <div className="form-group row">
                                            <label className="col-sm-2 col-form-label" style={{fontSize:'20px',fontFamily:'Acme'}}>Customer Phone</label>
                                        ...
                                        <div className={this.state.other ?  "col-sm-12" : 'none' }>
                                            ...
                                            <div className="form-group row">
                                                <label className="col-sm-2 col-form-label" style={{fontSize:'20px',fontFamily:'Acme'}}>Place of Supply *</label>
                                                <div className="col-sm-10">
