...
class Salesperson extends PureComponent {
    constructor(props) {
        super(props)
                                ...
                                <div className="col-md-4">
                                    <div className="card card-success card-outline">
                                        <div className="card-body box-profile">
                                            <h6 className="profile-username" style={{fontSize:'17px'}}>Mr {this.props.sale.name}</h6>
                                            <h6 style={{fontSize:'17px'}}>{this.props.sale.email}</h6>
                                            <h6 style={{fontSize:'17px'}}>{this.props.sale.contact}</h6>
                                        </div>
                                    </div>
                                    <div className="card card-success card-outline">
                                        <div className="card-body box-profile">
